...
export function MagneticCursorLayer({ children }: MagneticCursorLayerProps) {
  ...
  useEffect(() => {
    ...
    const hoverTargets = document.querySelectorAll<HTMLElement>("[data-magnetic]")
    ...
    const onEnter = (event: Event) =>
      handleEnter(event.currentTarget as HTMLElement)
    const onLeave = (event: Event) =>
      handleLeave(event.currentTarget as HTMLElement)
